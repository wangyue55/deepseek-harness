/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-intranet`.
 * @module @deepseek-ai/dsh-intranet/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-intranet'

/** Cordis companion plugin name. */
export const name = 'intranet-bundle-invariant'
